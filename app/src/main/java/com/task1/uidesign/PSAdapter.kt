...
import com.task1.uidesign.PService.Companion.policyService
import kotlinx.android.synthetic.main.business_list.view.*
import kotlinx.android.synthetic.main.policy_service.view.*
...
class PSAdapter (val context: Context, val policyService:ArrayList<PService>):RecyclerView.Adapter<PSAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):MyViewHolder{
        val view = LayoutInflater.from(context).inflate(R.layout.policy_service,parent,false)
